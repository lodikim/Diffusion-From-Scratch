...
def forward_diffusion_sample(x_0, t, betas, device="cpu"):
    ...
    sqrt_alphas_cumprod = torch.sqrt(alphas_cumprod)                    # square root of alphas_cumprod
    sqrt_one_minus_alphas_cumprod = torch.sqrt(1. - alphas_cumprod)     # square root of 1 minus alphas_cumprod

    noise = torch.randn_like(x_0)                                       # sample noise (from normal distribution of mean 0 & variance 1)
